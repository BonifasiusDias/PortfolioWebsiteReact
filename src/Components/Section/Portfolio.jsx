        ...
        <div>
          ...
          <div>
            ...
            <ul className=" grid grid-cols-4">
              <motion.div whileHover={{ scale: 1.1 }}>
                <li className=" border-2 border-gray-700 hover:border-yellow-500 rounded-lg mx-20 flex flex-col items-center h-36">
                  <SiJavascript className=" hover:text-yellow-500 text-gray-700 p-10 w-full h-full" />
                </li>
              </motion.div>
              <motion.div whileHover={{ scale: 1.1 }}>
                <li className="border-2 border-gray-700 hover:border-blue-500 rounded-lg mx-20 flex flex-col items-center h-36">
                  <SiTypescript className="hover:text-blue-500 text-gray-700 p-9 w-full h-full" />
                </li>
              </motion.div>
              <motion.div whileHover={{ scale: 1.1 }}>
                <li className="border-2 hover:border-red-500 border-gray-700 rounded-lg mx-20 flex flex-col items-center h-36">
                  <SiHtml5 className="hover:text-red-500 text-gray-700 p-9 w-full h-full" />
                </li>
              </motion.div>
              <motion.div whileHover={{ scale: 1.1 }}>
                <li className="border-2 hover:border-blue-600 border-gray-700 rounded-lg mx-20 flex flex-col items-center h-36">
          ...
          <div>
            ...
            <ul className="grid grid-cols-3 ">
              <motion.div whileHover={{ scale: 1.1 }}>
                <li className="border-2 hover:border-green-300 border-gray-700 rounded-lg mx-20 flex flex-col items-center h-36">
                  <SiTailwindcss className="hover:text-green-300 text-gray-700 p-9 w-full h-full" />
                </li>
              </motion.div>
              <motion.div whileHover={{ scale: 1.1 }}>
                <li className="border-2 hover:border-blue-300 border-gray-700 rounded-lg mx-20 flex flex-col items-center h-36">
                  <SiReact className="hover:text-blue-300 text-gray-700 p-9 w-full h-full" />
                </li>
              </motion.div>
              <motion.div whileHover={{ scale: 1.1 }}>
                <li className="border-2 hover:border-green-500 border-gray-700 rounded-lg mx-20 flex flex-col items-center h-36">
